...
abstract public class Product {
    ...
    public void setProduct(String productName, String color, double price, double length, double width, String size, int amountInStore) {
    ...
    public void setCustomerProduct(String productName, int quantity){
        ...
        for(String[] i:li){
            if (productName.equals(i[0])) {
                this.setProduct(i[0].trim(), i[1].trim(), DoubleParsing(i[2]), DoubleParsing(i[3]), DoubleParsing(i[4]), i[5].trim(), IntegerParsing(i[6]));
